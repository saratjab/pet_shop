...
router.patch('/user/alter', authenticate_1.authenticate, userController_1.updateUser);
router.patch('/user/role/:username', authenticate_1.authenticate, (0, authorize_1.authorizeRoles)('admin'), userController_1.updateUserRole);
